...
class C172_OilPressTempGauge(graphics.Container):
	...
	def __init__(self,position, size, batchImageRenderer, texture, name = "C172_OilPressTempGauge"):
		...
		self.oilGaugeRightNeedle.enableRotation ((49,0),[ [-7.821,-60.5],[100,36],[121.3636,59.5]])
		...
		self.oilGaugeLeftNeedle.enableRotation ((50,0),[ [58.33,62],[150,18],[200,-30],[257.6,-62]])
