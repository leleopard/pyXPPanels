...
class C172_VSI_Indicator(graphics.Container):
	...
	def __init__(self,position, size, batchImageRenderer, texture, zoom = 1.0, name = "C172_VSI_Indicator"):
		...
		self.varioNeedle.enableRotation ((4,2),[ [-2000,96.5],[-1500,140],[-1000,189.5],[-500,235],[0,270],[500,304.5],[1000,349.5],[1500,400],[2000,442.5]])
