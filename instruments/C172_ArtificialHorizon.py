...
class C172_ArtificialHorizon(graphics.Container):
	...
	def __init__(self,position, size, XPlaneDataDispatcher, batchImageRenderer, texture, zoom = 1.0, name = "C172_ArtificialHorizon"):
		...
		self.artHorizonOuterHor.enableRotation (XPlaneDataDispatcher,(17,1),[[-180,180],[0,0],[180,-180]])
		self.artHorizonInnerHor.enableRotation (XPlaneDataDispatcher,(17,1),[[-180,180],[0,0],[180,-180]])
		self.artHorizonInnerHor.enableTranslation (XPlaneDataDispatcher,(17,0),[[-25,48*zoom],[0,0],[25,-50*zoom]])
		self.artHorizonBackgroundHor.enableRotation (XPlaneDataDispatcher,(17,1),[ [-180,180],[0,0],[180,-180]])
		self.artHorizonPlaneGizmo.enableTranslation (XPlaneDataDispatcher,(306,0),[[-25,-48*zoom],[0,0],[25,50*zoom]])
