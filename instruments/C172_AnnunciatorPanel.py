...
class C172_AnnunciatorPanel(graphics.Container):
	...
	def __init__(self,position, size, XPlaneDataDispatcher, batchImageRenderer, texture, name = "C172_AnnunciatorPanel"):
		...
		self.C172_AnnunciatorPanel_alternator.toggleVisibility(self.XPlaneDataDispatcher, (115,4), conversionFunctions.returnTrueIfOverZero)
		...
		self.C172_AnnunciatorPanel_battery.toggleVisibility(self.XPlaneDataDispatcher, (113,5), conversionFunctions.returnTrueIfOverZero)
		...
		self.C172_AnnunciatorPanel_lowfuel.toggleVisibility(self.XPlaneDataDispatcher, (113,6), conversionFunctions.returnTrueIfOverZero)
		...
		self.C172_AnnunciatorPanel_brakes.toggleVisibility(self.XPlaneDataDispatcher, (14,1), conversionFunctions.returnTrueIfOverZero)
		...
		self.C172_AnnunciatorPanel_oilpress.toggleVisibility(self.XPlaneDataDispatcher, (115,1), conversionFunctions.returnTrueIfOverZero)
		...
		self.C172_AnnunciatorPanel_oiltemp.toggleVisibility(self.XPlaneDataDispatcher, (115,2), conversionFunctions.returnTrueIfOverZero)
