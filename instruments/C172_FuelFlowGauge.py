...
class C172_FuelFlowGauge(graphics.Container):
	...
	def __init__(self,position, size, XPlaneDataDispatcher, batchImageRenderer, texture, name = "C172_FuelFlowGauge"):
		...
		self.fuelFlowGaugeRightNeedle.enableRotation (XPlaneDataDispatcher,(45,0),[ [2.81,-65],[4,-57],[15,17],[19,55],[19.84,63]],conversionFunctions.convertLbsToGallons)
		...
		self.fuelFlowGaugeLeftNeedle.enableRotation (XPlaneDataDispatcher,(47,0),[ [0,58],[100,52],[1700,-49],[1900,-62]])
